...
for line in open(path, 'r', encoding='utf-8'):
    try:
        ...
        if step > 1650: # The restore happened around 1660, so stop here to get the glassmorphism
            # Wait, the restore happened at step 1668. 
            # The writes for glassmorphism were at 1557, 1616...
            pass
