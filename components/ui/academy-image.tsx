...
const sportImages: Record<string, string> = {
  cricket: 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=800&h=600&fit=crop',
  football: 'https://images.unsplash.com/photo-1551776235-dde6d4829800?w=800&h=600&fit=crop',
  basketball: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=800&h=600&fit=crop',
  badminton: 'https://images.unsplash.com/photo-1613915642601-0a2e1b104723?w=800&h=600&fit=crop',
...
export function AcademyImage({
  ...
  const sportImage = sportsOffered?.[0] ? sportImages[sportsOffered[0]] : null;

  const src = React.useMemo(() => {
    if (coverImage) return coverImage;
    if (sportImage) return sportImage;
    return `/images/sports/${sportsOffered?.[0] || 'athletics'}.svg`;
  }, [coverImage, sportImage, sportsOffered]);
