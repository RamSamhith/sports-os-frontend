...
const sportColorMap: Record<string, string> = {
  cricket: 'bg-blue-500/15 text-blue-600 dark:text-blue-400',
  football: 'bg-emerald-500/15 text-emerald-600 dark:text-emerald-400',
  basketball: 'bg-orange-500/15 text-orange-600 dark:text-orange-400',
  badminton: 'bg-violet-500/15 text-violet-600 dark:text-violet-400',
  tennis: 'bg-yellow-500/15 text-yellow-600 dark:text-yellow-400',
  'table-tennis': 'bg-cyan-500/15 text-cyan-600 dark:text-cyan-400',
  swimming: 'bg-sky-500/15 text-sky-600 dark:text-sky-400',
  athletics: 'bg-red-500/15 text-red-600 dark:text-red-400',
  wrestling: 'bg-amber-500/15 text-amber-600 dark:text-amber-400',
  boxing: 'bg-rose-500/15 text-rose-600 dark:text-rose-400',
  karate: 'bg-pink-500/15 text-pink-600 dark:text-pink-400',
  judo: 'bg-purple-500/15 text-purple-600 dark:text-purple-400',
  kabaddi: 'bg-lime-500/15 text-lime-600 dark:text-lime-400',
  hockey: 'bg-indigo-500/15 text-indigo-600 dark:text-indigo-400',
  chess: 'bg-slate-500/15 text-slate-600 dark:text-slate-400',
  skating: 'bg-teal-500/15 text-teal-600 dark:text-teal-400',
  archery: 'bg-fuchsia-500/15 text-fuchsia-600 dark:text-fuchsia-400',
  shooting: 'bg-stone-500/15 text-stone-600 dark:text-stone-400',
  yoga: 'bg-green-500/15 text-green-600 dark:text-green-400',
  gymnastics: 'bg-pink-500/15 text-pink-600 dark:text-pink-400',
};
