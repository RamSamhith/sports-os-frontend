        ...
        action={
          onClear ? (
            <button
              type="button"
              onClick={onClear}
              className="bg-primary text-primary-foreground hover:bg-primary/90 motion-premium inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium"
            >
              {clearLabel}
            </button>
          ) : null
